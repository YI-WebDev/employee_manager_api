...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "department": {
                "error_messages": {
                    "blank": "所属部署は必須項目です。",
                    "invalid_choice": "所属部署は必須項目です。",
                }
            },
            "joined_date": {
                "error_messages": {
                    "blank": "入社年月日は必須項目です。",
                    "invalid": "入社年月日は必須項目です。",
                }
            },
            "termination_date": {
                "error_messages": {
                    "blank": "退社年月日は必須項目です。",
                    "invalid": "退社年月日は必須項目です。",
                }
            },
        }
    ...
    def validate(self, data):
        ...
        if (
            ...
            and data.get("joined_date")
            and data["termination_date"] < data["joined_date"]
        ):
            errors["termination_date"] = (
                "退職日が入社日より早い日付で指定されています。"
            )
        if (
            data.get("joined_date")
            and data.get("birth_date")
            and data["joined_date"] < data["birth_date"]
        ):
